    ...
    <div className="adress">
      <div className="adress__text">
        ...
        <div className="adress__info">
          ...
          <p className='adress__description'>Bohaterów Modlina 32 <br /> 05-100 Nowy Dwór Mazowiecki</p>
        </div>
      </div>
      <div className="adress__text">
      ...
      <div className="adress__text">
        ...
        <div className='adress__info'>
          ...
          <a href="mailto: demo@example.com" className='adress__link'>demo@example.com</a>
