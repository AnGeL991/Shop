...
export const SlideBanner: FC = () => {
  ...
  const data= [{
    id:1,
    image:'http://wordpress.templatemela.com/woo/WCM05/WCM050119/wp-content/uploads/2019/08/main-banner-2.jpg',
    title:'Summer Sale!',
  ...
  {
    id:2,
    image:'http://wordpress.templatemela.com/woo/WCM05/WCM050119/wp-content/uploads/2019/08/Main-banner-01.jpg',
    title:'Summer Sale!',
    subTitle:'Trumblers cups & ceramic',
    description:'Understand introductions to ceramic materials',
    buttons:['shop now'],
